...
export default class ProductManager {
  ...
  addProduct = async({title,description,category,price,thumnails,code,stock,status})=>{
    try {
      const products = await this.getProducts();
      const product = {title,description,category,price,thumnails,code,stock,status};
      if (
        (!title,!description,!category,!price,!thumnails,!code,!stock,!status)
      ) {
